    ...
    **kwargs
    ...
    for anchors in all_anchors:
        ...
        if annotations.shape[0]:
            ...
            annotation_targets = annotations[argmax_overlaps_inds]

            # fg label: above threshold IOU
            positive_indices = max_overlaps >= positive_overlap
            labels[positive_indices, :] = 0
            labels[positive_indices, annotation_targets[positive_indices, 4].astype(int)] = 1
        else:
            # no annotations? then everything is background
            labels[:] = 0
            annotation_targets = np.zeros_like(anchors)
        ...
        all_annotation_targets.append(annotation_targets)

    return all_labels, all_annotation_targets, all_anchors
